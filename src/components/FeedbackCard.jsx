...
const FeedbackCard = () => {
    return (
        <div className="container mx-auto w-9/10 md:w-3/4 p-2 md:p-6 shadow-lg rounded-lg">
            <div className="w-full md:w-1/3 mx-auto text-center  p-3">
                <h2 className="text-lg font-semibold mb-3">Свяжитесь с нами</h2>
                ...
                <div className="flex space-x-4 justify-center">
                    <a
                        ...
                        className="hover:scale-105 transition-transform duration-500 flex items-center space-x-2 px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition"
                    >
                        <FaWhatsapp size={20}/>
                        <span>WhatsApp</span>
                    </a>
